...
// 	protoc        v3.19.4
// source: pkg/api/customer/proto/customer.proto
...
func (x *Empty) Reset() {
	*x = Empty{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_api_customer_proto_customer_proto_msgTypes[0]
...
func (*Empty) Descriptor() ([]byte, []int) {
	return file_pkg_api_customer_proto_customer_proto_rawDescGZIP(), []int{0}
}
...
func (x *Request) Reset() {
	*x = Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_api_customer_proto_customer_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_pkg_api_customer_proto_customer_proto_rawDescGZIP(), []int{1}
}
...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_api_customer_proto_customer_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_pkg_api_customer_proto_customer_proto_rawDescGZIP(), []int{2}
}
...
var File_pkg_api_customer_proto_customer_proto protoreflect.FileDescriptor

var file_pkg_api_customer_proto_customer_proto_rawDesc = []byte{
	0x0a, 0x25, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
...
var (
	file_pkg_api_customer_proto_customer_proto_rawDescOnce sync.Once
	file_pkg_api_customer_proto_customer_proto_rawDescData = file_pkg_api_customer_proto_customer_proto_rawDesc
)

func file_pkg_api_customer_proto_customer_proto_rawDescGZIP() []byte {
	file_pkg_api_customer_proto_customer_proto_rawDescOnce.Do(func() {
		file_pkg_api_customer_proto_customer_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_api_customer_proto_customer_proto_rawDescData)
	})
	return file_pkg_api_customer_proto_customer_proto_rawDescData
}

var file_pkg_api_customer_proto_customer_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pkg_api_customer_proto_customer_proto_goTypes = []interface{}{
	(*Empty)(nil),    // 0: utl.grpc.customer.Empty
	(*Request)(nil),  // 1: utl.grpc.customer.Request
	(*Response)(nil), // 2: utl.grpc.customer.Response
}
var file_pkg_api_customer_proto_customer_proto_depIdxs = []int32{
...
func init() { file_pkg_api_customer_proto_customer_proto_init() }
func file_pkg_api_customer_proto_customer_proto_init() {
	if File_pkg_api_customer_proto_customer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_api_customer_proto_customer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_api_customer_proto_customer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_api_customer_proto_customer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_api_customer_proto_customer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_api_customer_proto_customer_proto_goTypes,
		DependencyIndexes: file_pkg_api_customer_proto_customer_proto_depIdxs,
		MessageInfos:      file_pkg_api_customer_proto_customer_proto_msgTypes,
	}.Build()
	File_pkg_api_customer_proto_customer_proto = out.File
	file_pkg_api_customer_proto_customer_proto_rawDesc = nil
	file_pkg_api_customer_proto_customer_proto_goTypes = nil
	file_pkg_api_customer_proto_customer_proto_depIdxs = nil
}
